...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/spetersenms/AL-Go/FixDownloadedAppsPublished/Actions/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/spetersenms/AL-Go/FixDownloadedAppsPublished/Actions/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/spetersenms/AL-Go/FixDownloadedAppsPublished/Actions/Packages.json' -folder $tmpFolder | Out-Null
